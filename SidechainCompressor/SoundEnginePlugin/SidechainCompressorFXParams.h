...
#ifndef SidechainCompressorFXParams_H
#define SidechainCompressorFXParams_H
...
static const AkPluginParamID PARAM_MAXRATIO_ID = 1;
static const AkPluginParamID PARAM_PRIORITYRANK_ID = 2;
static const AkUInt32 NUM_PARAMS = 3;

struct SidechainCompressorRTPCParams
{
    AkReal32 fThreshold;
    AkReal32 fMaxRatio;
    AkReal32 fPriorityRank;
};

struct SidechainCompressorNonRTPCParams
{
};

struct SidechainCompressorFXParams
    : public AK::IAkPluginParam
{
    SidechainCompressorFXParams();
    SidechainCompressorFXParams(const SidechainCompressorFXParams& in_rParams);
    ...
    SidechainCompressorRTPCParams RTPC;
    SidechainCompressorNonRTPCParams NonRTPC;
};

#endif // SidechainCompressorFXParams_H
