...
class SidechainCompressorPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    SidechainCompressorPlugin();
    ~SidechainCompressorPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(SidechainCompressor);	// Exposes our PluginContainer structure that contains the info for our plugin
