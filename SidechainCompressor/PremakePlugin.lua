...
local Plugin = {}
Plugin.name = "SidechainCompressor"
Plugin.factoryheader = "../SoundEnginePlugin/SidechainCompressorFXFactory.h"
Plugin.appleteamid = ""
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
...
{
    "SidechainCompressorFXShared.cpp"
}
...
{
    "SidechainCompressorFXShared.cpp",
    "SidechainCompressorFXFactory.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "SidechainCompressor.def",
    "SidechainCompressor.xml",
    "**.rc",
}
