...
#ifndef SidechainCompressorConfig_H
#define SidechainCompressorConfig_H
...
namespace SidechainCompressorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 25358;
}

#endif // SidechainCompressorConfig_H
